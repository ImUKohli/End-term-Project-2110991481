        ...
        <div className="flex justify-between gap-10 mb-[30px]">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-[14px] leading-6 text-textColor">{formateDate("01-13-2024")}</p>
                <p className="text__para mt-3 font-medium text-[15px]">Great Doctor and very polite Doctor. Highly Recommended👍</p>
              </div>
            </div>
